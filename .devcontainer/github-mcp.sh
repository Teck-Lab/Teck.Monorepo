...
export GITHUB_TOOLS="${GITHUB_TOOLS:-get_repository_tree,get_file_contents,get_commit,list_branches,list_commits,issue_read,issue_write,sub_issue_write,issue_dependency_read,issue_dependency_write,add_issue_comment,search_issues,list_issues,create_pull_request,update_pull_request,pull_request_read,list_pull_requests,search_pull_requests,actions_get,actions_list,get_job_logs}"

exec /usr/local/bin/github-mcp-server stdio --features issue_dependencies
