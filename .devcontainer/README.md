...
The pinned OMO 5 beta reads the repository-owned unified configuration from
`.omo/omo.jsonc`. Post-create removes configuration generated by the retired
4.19 bootstrap so a persistent home volume cannot trigger legacy migration.
