...
# OMO 5 reads the repository-owned unified config from .omo/omo.jsonc.
# Remove files generated by the retired 4.19 bootstrap so they cannot trigger
# legacy migration or shadow diagnostics in rebuilt persistent home volumes.
