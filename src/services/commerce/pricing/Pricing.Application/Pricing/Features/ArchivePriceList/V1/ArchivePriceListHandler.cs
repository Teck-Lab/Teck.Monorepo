...
/// <summary>Handles <see cref="ArchivePriceListCommand"/>.</summary>
public static class ArchivePriceListHandler
{
    /// <summary>Loads, archives, commits, and publishes a Removed event per price (when previously active).</summary>
    /// <param name="command">The command.</param>
    /// <param name="repository">The write repository.</param>
    /// <param name="unitOfWork">The unit of work.</param>
    /// <param name="bus">The message bus.</param>
    /// <param name="ct">A cancellation token.</param>
    /// <returns>The archived list, or a not-found error.</returns>
    public static async Task<ErrorOr<PriceListDto>> Handle(
        ArchivePriceListCommand command,
