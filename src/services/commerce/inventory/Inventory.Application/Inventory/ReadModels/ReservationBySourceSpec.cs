...
public sealed class ReservationBySourceSpec : Specification<Reservation>
{
    ...
    public ReservationBySourceSpec(ReservationSource source, Guid sourceId) =>
        Query.Where(reservation => reservation.SourceType == source && reservation.SourceId == sourceId);
}
