...
/// <summary>Publishes a shopper-safe cancelled-order notification request.</summary>
[MemoryPackable(GenerateType.VersionTolerant)]
public partial class OrderCancelledIntegrationEvent
{
    ...
    /// <summary>Gets or sets shopper-safe cancellation text.</summary>
    [MemoryPackOrder(4)]
