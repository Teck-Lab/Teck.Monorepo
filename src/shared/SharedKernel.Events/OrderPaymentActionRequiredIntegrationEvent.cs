...
/// <summary>Publishes a shopper-safe request for a payment action.</summary>
[MemoryPackable(GenerateType.VersionTolerant)]
public partial class OrderPaymentActionRequiredIntegrationEvent
{
    ...
    /// <summary>Gets or sets the shopper-safe decline category.</summary>
    [MemoryPackOrder(4)]
