...
/// <summary>Publishes a shopper-safe rejected-order notification request.</summary>
[MemoryPackable(GenerateType.VersionTolerant)]
public partial class OrderRejectedIntegrationEvent
{
    ...
    /// <summary>Gets or sets the shopper-safe rejection category.</summary>
    [MemoryPackOrder(4)]
